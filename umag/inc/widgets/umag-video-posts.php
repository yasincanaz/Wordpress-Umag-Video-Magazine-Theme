...
class Umag_Video_Posts extends WP_Widget {

	function __construct() {
		parent::__construct(
			'umag_video_posts',
			esc_html__( 'Umag video post', 'umag' ),
			array( 'description' => esc_html__( 'You can select your featured video posts here', 'umag' ), ) // Args
		);
	}
	...
	public function widget( $args, $instance ) {
        ...
        while($widget_posts->have_posts()){
            ...
            get_template_part( "template-parts/video","post");
        }
...
function umag_register_video_post() {
	register_widget( 'Umag_Video_Posts' );
}
add_action( 'widgets_init', 'umag_register_video_post' );