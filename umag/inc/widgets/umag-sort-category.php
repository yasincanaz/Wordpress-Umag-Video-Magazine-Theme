...
class Umag_Sort_Category extends WP_Widget {

	function __construct() {
		parent::__construct(
			'umag_short_category',
			esc_html__( 'umag Category', 'umag' ),
...
function register_umag_short_category() {
	register_widget( 'Umag_Sort_Category' );
}
add_action( 'widgets_init', 'register_umag_short_category' );